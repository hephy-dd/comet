...
def test_linear_range():
    ...
    assert_linear_range(
        0, 1.001e-15, 2e-16, [0, 2e-16, 4e-16, 6e-16, 8e-16, 1e-15, 1.001e-15]
    )  # jump
    assert_linear_range(
        1e-15, 0, -2e-16, [1e-15, 8e-16, 6e-16, 4e-16, 2e-16, 0]
    )  # auto step
    assert_linear_range(
    ...
    assert_linear_range(
        -2.5e-12, 2.5e-12, -2.5e-12, [-2.5e-12, 0, 2.5e-12]
    )  # auto step
    ...
    assert_linear_range(-2.5e12, 2.5e12, -2.5e12, [-2.5e12, 0, 2.5e12])  # auto step
    assert_linear_range(-2.5e12, 2.5e12, 2.5e12, [-2.5e12, 0, 2.5e12])
    assert_linear_range(2.5e12, -2.5e12, 2.5e12, [2.5e12, 0, -2.5e12])  # auto step
    assert_linear_range(2.5e12, -2.5e12, -2.5e12, [2.5e12, 0, -2.5e12])

    assert_linear_range(
        -2.5e-24, 2.5e-24, -2.5e-24, [-2.5e-24, 0, 2.5e-24]
    )  # auto step
    ...
    assert_linear_range(-2.5e24, 2.5e24, -2.5e24, [-2.5e24, 0, 2.5e24])  # auto step
    assert_linear_range(-2.5e24, 2.5e24, 2.5e24, [-2.5e24, 0, 2.5e24])
    assert_linear_range(2.5e24, -2.5e24, 2.5e24, [2.5e24, 0, -2.5e24])  # auto step
    assert_linear_range(2.5e24, -2.5e24, -2.5e24, [2.5e24, 0, -2.5e24])
