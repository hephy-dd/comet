...
class FunctionsTest(unittest.TestCase):
    ...
    def test_range(self):
        ...
        self.assert_range(0, 1.001e-15, 2e-16, [0, 2e-16, 4e-16, 6e-16, 8e-16, 1e-15, 1.001e-15])  # jump
        self.assert_range(1e-15, 0, -2e-16, [1e-15, 8e-16, 6e-16, 4e-16, 2e-16, 0])  # auto step
